...
class TestHelpers(unittest.TestCase):
    ...
    def test_offer_to_dict(self):
        ...
        self.assertEqual(xmlparse.offer_to_dict(tag_offer), expected)
    ...
    def test_reform_store_dicts(self):
        ...
        expected = (expected_inventory, expected_stores)

        self.assertEqual(xmlparse.reform_store_dicts(source_dict), expected)
    ...
    def test_parse_xml_string(self):
        ...
        self.assertEqual(xmlparse.parse_xml_string(EXAMPLE), expected)
